...
// Order structure with 6 attributes
struct Order {
    int orderID;              // 1. Order ID
    string customerName;      // 2. Customer Name
    string productName;       // 3. Product Name
    string productCategory;   // 4. Product Category (for reports only)
...
void displayFirstNOrders(int n, bool sorted) {
    ...
    cout << " No  OrderID  Customer Name        Product Name         Category         Qty   UnitPrice  OrderDate      TotalAmt\n";
    cout << "========================================================================================================\n";
...
void displayOrder(Order* order, int index) {
    cout << setw(4) << right << index << " "
         ...
         << setw(20) << left << order->customerName.substr(0, 19) << " "
         << setw(20) << order->productName.substr(0, 19) << " "
         << setw(16) << left << order->productCategory.substr(0, 15) << " "
         << setw(4) << right << order->quantity << " "
         << setw(12) << fixed << setprecision(2) << order->unitPrice << " "
         << setw(12) << left << order->orderDate << " "
         << setw(12) << right << fixed << setprecision(2) << order->totalAmount
         << "\n";
}
